    ...
    <div className="">
      ...
      <div className="">
        ...
        <div className="flex gap-4 justify-between mt-6">
          {/* AVATAR */}
          <Image
            src="https://images.pexels.com/photos/33145845/pexels-photo-33145845.jpeg"
            alt=""
            width={40}
            height={40}
          ...
          <div className="flex flex-col gap-2 flex-1">
            ...
            <p>
              ...
              asperiores reiciendis nobis rerum dolore, earum distinctio
              consequuntur nihil quos, deserunt maiores. Cum ipsum asperiores
              laboriosam nam maiores placeat inventore illo.
            </p>
